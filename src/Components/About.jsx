        ...
        <div className="col-md-5 d-flex justify-content-center align-items-center">
          <div className={`container my-5 ${styles.Abouttextbox}`}>
            ...
            <p className={`lead  `}>
              ...
              and data interpretation. Not only does CIT implant an idea of
              various acclaimed aptitude tests like CAT, but our flagship event
              also never fails to provide a simulation of the overall screening
              procedure of the hiring companies. This is the most anticipated
              online event to compete for intellectual glory among a multitude
              of striving contestants.
            </p>
          </div>
        </div>

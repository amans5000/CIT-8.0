  ...
  return (<>
    ...
    <div className={`container-fluid cit-title ${styles.citTitle}`}>
        <div className={` container-fluid title ${styles.title}`}>
            Cognitive<br/><span> <b>Intelligence</b> Test</span>
        </div>
        <div className=" container-fluid title-btns">
            <div className={`container-fluid btns ${styles.titleBtns}`}>
                <button className={`hero-btn login-btn ${styles.loginBtn}`}>Log in</button>
                <button className={`hero-btn register-btn ${styles.registerBtn}`}>Register</button>
            </div>
        </div>
    </div>
